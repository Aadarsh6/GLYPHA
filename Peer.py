...
def chat(sock, box, peer_fp, name, peer_display=None, meta=None):
    """Conversation loop: grouped rendering, receive thread whose output
    slides above your input, slash commands, encrypted send loop."""
    peer_label = peer_display or "Them"   # never your own name
